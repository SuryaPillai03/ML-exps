...
master = Tk()
master.title("Surya => 211P015 Customer Segmentation using Machine Learning")
Label(master, text="Surya => 211P015 Customer Segmentation using Machine Learning", bg="Yellow", fg="black").grid(row=0, columnspan=2)
